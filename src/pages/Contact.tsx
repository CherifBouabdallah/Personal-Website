...
export default function Contact() {
  ...
  const titleScale = useTransform(smoothProgress, [0, 1], [1, 0.45]);
  ...
  const socials = [
    ...
    { name: "EMAIL", url: "mailto:hello@example.com", icon: <EmailIcon /> },
  ];

  return (
    <div className="w-full h-screen min-h-screen flex flex-col items-center justify-center relative overflow-hidden select-none">
      {/* Title */}
      <motion.div
      ...
      <motion.div
        ...
        className="absolute z-10 flex items-center justify-center gap-8 md:gap-14"
      >
        {socials.map((social) => (
          <a
            key={social.name}
